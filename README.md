...
upgrade your python and npm.
 ...
 2.- Download by clicking to this link **Spot Placement Score Dashboard Cdk- 0.7.0 version from Github**
to your desktop:

 3.- Upload the file **spot-placement-score-dashboard-cdk-v0.7.0.tar.gz**
...
```
tar xzvf spot-placement-score-dashboard-cdk-v0.6.0.tar.gz
mv spot-placement-score-dashboard-cdk-v0.6.0/ spot-placement-score-dashboard-cdk
cd $HOME/environment/spot-placement-score-dashboard-cdk
```
